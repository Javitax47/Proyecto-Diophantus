...
# 1. Definir Variables
var_names = ['amount_in', 'amount_in_next', 'amount_out_next', 'e_0', 'rIn_0', 'rIn_0_next', 'rIn_1', 'rIn_1_next', 'rIn_2', 'rIn_2_next', 'rOut_0', 'rOut_0_next', 'rOut_1', 'rOut_1_next', 'rOut_2', 'rOut_2_next']
