...
TESTS = [
    ...
    ("test_dioph_pell.py",            "Calculo diofantico: arsenal de Pell (P1-P5) verificado"),
    ("test_dioph_calculus.py",        "Calculo diofantico: lemas certificados, coste exacto y testigo"),
    ("test_dioph_problems.py",        "Calculo diofantico: catalogo universal y verificador unico"),
    ("test_dioph_degree.py",          "Calculo diofantico: reduccion de grado (frontera de Pareto)"),
    ...
    ("test_dioph_jsww3.py",           "Calculo diofantico: fidelidad de la transcripcion del Teorema 3.9 de JSWW"),
    ("test_dioph_combinar.py",        "Calculo diofantico: el teorema de combinacion de relaciones (Matijasevic-Robinson)"),
