...
with the system published in \cite{jsww1976}. The first appears to be the first
prime generator of degree $5$ written down; the second improves by five
variables on the only previously exhibited generator at that degree. We have
...
$(10,>6000)$ of \cite{matiyasevich1981} dominates everything our method reaches,
and going below it would require the nine-unknowns machinery, which our
approach---transcribe a published system, eliminate, flatten, and measure---does
not reproduce. In the degree, $5$ is the floor by
Proposition~\ref{prop:gen}, so the only question there is the variable count,
and we do not know whether $44$ can be lowered.
